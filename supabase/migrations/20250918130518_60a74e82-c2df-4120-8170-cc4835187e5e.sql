-- Ajouter des commandes fictives cohérentes
DO $$
DECLARE
    user1_id uuid;
    user2_id uuid; 
...
BEGIN
    ...
    SELECT id INTO product1_id FROM products WHERE name ILIKE '%nike%' LIMIT 1;
    SELECT id INTO product2_id FROM products WHERE name ILIKE '%adidas%' OR name ILIKE '%chaussure%' LIMIT 1;
    ...
    -- Insérer des commandes fictives avec différentes dates et statuts
    ...
    (order3_id, user3_id, 'EDN-2025-001-9012', 'processing', 'paid', 199.50, NOW() - INTERVAL '2 hours', '{"street": "789 Boulevard Saint-Germain", "city": "Marseille", "postalCode": "13001", "country": "France"}', '{"street": "789 Boulevard Saint-Germain", "city": "Marseille", "postalCode": "13001", "country": "France"}', 'bank_transfer'),
    (order4_id, user1_id, 'EDN-2025-001-3456', 'completed', 'paid', 299.99, NOW() - INTERVAL '5 days', '{"street": "123 Rue de la Paix", "city": "Paris", "postalCode": "75001", "country": "France"}', '{"street": "123 Rue de la Paix", "city": "Paris", "postalCode": "75001", "country": "France"}', 'credit_card'),
    ...
    -- Insérer des factures cohérentes
    ...
    ('FACT-FOUR-001', 'fournisseur', NULL, variant1_id, 'Nike France', 'commandes@nike.fr', 1200.00, 85.00, 20, 'paid', 'bank_transfer', 'EUR', NOW() - INTERVAL '7 days', NOW() - INTERVAL '6 days', NOW() - INTERVAL '8 days', '{"restock_batch": "NIKE-RST-001", "delivery_date": "2025-01-25"}'),
    ('FACT-FOUR-002', 'fournisseur', NULL, variant2_id, 'Adidas Europe', 'supply@adidas.eu', 900.00, 75.00, 15, 'pending', 'credit_card', 'EUR', NOW() + INTERVAL '7 days', NULL, NOW() - INTERVAL '2 days', '{"restock_batch": "ADIDAS-RST-002", "delivery_date": "2025-01-30"}');
